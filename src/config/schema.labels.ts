...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.consentGate.enabled": "ConsentGate Enabled",
  "gateway.consentGate.gatedTools": "ConsentGate Gated Tools",
  "gateway.consentGate.observeOnly": "ConsentGate Observe Only",
  "gateway.consentGate.storagePath": "ConsentGate Storage Path",
  "gateway.consentGate.provider": "ConsentGate Provider",
  "gateway.consentGate.audit": "ConsentGate Audit",
  "gateway.consentGate.audit.enabled": "ConsentGate Audit Enabled",
  "gateway.consentGate.audit.destination": "ConsentGate Audit Destination",
  "gateway.consentGate.audit.redactSecrets": "ConsentGate Audit Redact Secrets",
